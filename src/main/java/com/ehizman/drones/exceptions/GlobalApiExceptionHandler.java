...
import com.ehizman.drones.exceptions.dtos.ErrorResponseDto;
import com.ehizman.drones.exceptions.dtos.InvalidParameterDto;
...
import static com.ehizman.drones.exceptions.util.ErrorResponseUtil.build;
...
public class GlobalApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Handles the uncaught {@link DronesApplicationException} exceptions and returns a JSON formatted response.
     *
     * @param ex      the ex
     * @param request the request on which the ex occurred
     * @return a JSON formatted response containing the ex details and additional fields
     */
    @ExceptionHandler({DronesApplicationException.class})
    public ResponseEntity<Object> handleCustomUncaughtBusinessException(final DronesApplicationException ex,
